...
"[project]/src/app/view-table/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ViewTablePage() {
    ...
    const [data, setData] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]); // Updated type
    const [loading, setLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true);
    const [error, setError] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ViewTablePage.useEffect": ()=>{
    ...
    const fetchTableData = async ()=>{
        ...
        switch(tableName){
            case "buyer":
                endpoint = "".concat(API_URL, "/orders/buyer/all");
                break;
            case "seller":
                endpoint = "".concat(API_URL, "/orders/seller/all");
                break;
            case "top_buyer":
                endpoint = "".concat(API_URL, "/orders/all");
                break;
            case "top_seller":
                endpoint = "".concat(API_URL, "/orders/all");
                break;
        ...
        try {
            ...
            if (response.ok) {
                ...
                if (tableName === "top_buyer") {
                    const topBuyerResponse = await fetch("".concat(API_URL, "/top-orders/all"));
                    if (topBuyerResponse.ok) {
                        const topResult = await topBuyerResponse.json();
                        processedData = topResult.top_buyer_0 || [];
                        if (topResult.top_buyer_1) processedData = [
                            ...processedData,
                            ...topResult.top_buyer_1
                        ];
                        if (topResult.top_buyer_2) processedData = [
                            ...processedData,
                            ...topResult.top_buyer_2
                        ];
                        processedData.sort((a, b)=>b.price - a.price);
                    }
                } else if (tableName === "top_seller") {
                    const topSellerResponse = await fetch("".concat(API_URL, "/top-orders/all"));
                    if (topSellerResponse.ok) {
                        const topResult = await topSellerResponse.json();
                        processedData = topResult.top_seller_0 || [];
                        if (topResult.top_seller_1) processedData = [
                            ...processedData,
                            ...topResult.top_seller_1
                        ];
                        if (topResult.top_seller_2) processedData = [
                            ...processedData,
                            ...topResult.top_seller_2
                        ];
                ...
                const transformedData = processedData.map((item)=>{
                    ...
                    return {
                        ...
                        transaction_type: getTransactionTypeName(item.transaction_type)
                    };
                });
                // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    const getTableTitle = ()=>{
        switch(tableName){
            case "buyer":
                return "All Buyer Orders (Highest to Lowest)";
            case "seller":
                return "All Seller Orders (Lowest to Highest)";
            case "top_buyer":
                return "Top 10 Buyer Orders (Highest Prices)";
            case "top_seller":
                return "Top 10 Seller Orders (Lowest Prices)";
            default:
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tbody", {
                                        ...
                                        children: data.map((row, idx)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                                className: "".concat(idx % 2 === 0 ? "bg-white" : "bg-gray-50", " hover:bg-green-100 transition-colors cursor-pointer"),
...
_s(ViewTablePage, "Zv2xh1uhl+aeH9gMfXZs+APWVKk=");
_c = ViewTablePage;
var _c;
__turbopack_context__.k.register(_c, "ViewTablePage");
...
//# sourceMappingURL=_b7df40fa._.js.map